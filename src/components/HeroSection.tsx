...
const DEFAULT_IMAGES = [
  ...
  'https://cdn.poehali.dev/projects/1d5e1d48-86d9-45a1-af89-a126fe2acc90/files/ea2439a9-08ae-4f3d-b8e7-9d4b8c82749a.jpg',
];
          ...
          <div className="flex max-w-2xl flex-col gap-8">
            ...
            >
              <div className="flex flex-wrap gap-4">
                <a
                  href="#dogs"
                  className="inline-flex items-center gap-2 bg-amber-400 hover:bg-amber-500 text-black font-semibold px-6 py-3 transition-colors"
                >
                  Наши собаки
                </a>
                <a
                  href="#contacts"
                  className="inline-flex items-center gap-2 border border-white/40 hover:border-white text-white px-6 py-3 transition-colors"
                >
                  Связаться с нами
                </a>
              </div>
